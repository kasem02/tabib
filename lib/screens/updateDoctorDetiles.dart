...
class updatedoctorDetils extends StatefulWidget {
  ...
  const updatedoctorDetils({Key? key, required this.label, required this.field}) : super(key: key);

  @override
  State<updatedoctorDetils> createState() => _updatedoctorDetilsState();
}

class _updatedoctorDetilsState extends State<updatedoctorDetils> {
              ...
              builder: (context, snapshot) {
                ...
                return Container(
                  ...
                  child: TextFormField(
                    ...
                    //initialValue: _textcontroller.text, // إضافة هنا
                    ...
                    validator: (value) {
                      if (value!.isEmpty)
                        return 'نرجو منك ادخال ' + widget.label;
                      return null;
                    },
                  ),
                );              },
