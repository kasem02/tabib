...
class doctoraprrvedappmoent extends StatefulWidget {
  const doctoraprrvedappmoent({Key? key}) : super(key: key);

  @override
  State<doctoraprrvedappmoent> createState() => _doctoraprrvedappmoentState();
}

class _doctoraprrvedappmoentState extends State<doctoraprrvedappmoent> {
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          List<DocumentSnapshot> filteredList = snapshot.data!.docs.where((document) {
            ...
            return document['doctormail'] == user!.email! && document['approved'] =='true';
